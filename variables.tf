...
variable "create_cluster" {
  description = "Whether to create ECS cluster or use existing cluster"
  type = bool
  default = true
}
...
variable "scaling_policy" {
  description = "(Optional) A map of application autoscaling policy's configurations"
  type = map
  default = {}
}

variable "scaling_alarm" {
  description = "(Optional) A map of application's cloudwatch metric alarm configurations"
  type = map
  default = {}
}
